...
import type { MoodboardData, MoodboardFolderData } from "@/lib/moodboard/types";
      ...
      {draggedMoodboard && (
        <div ref={sortable.overlayRef} style={sortable.overlayStyle}>
          <div className="rounded-lg border border-[var(--border-default)] overflow-hidden bg-[var(--bg-elevated)] shadow-2xl shadow-black/50 rotate-[1.5deg]">
            <BoardThumb previewKey={draggedMoodboard.previewKey ?? null} title={draggedMoodboard.title} background={draggedMoodboard.background} />
...
function MoodboardCard({
  ...
  return (
    ...
    >
      {/* Aperçu précalculé (R2) — plus de lecture de canvasData */}
      <BoardThumb previewKey={moodboard.previewKey ?? null} title={moodboard.title} background={moodboard.background} />
